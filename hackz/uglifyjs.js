...
function uglifyjsWorkerImpl(context, uglifyJsConfig) {
    return Promise.resolve().then(function () {
        ...
        jsFilePaths.forEach(function (bundleFilePath) {
            ...
            var code = minifyOutput.code.toString();

            code = 'performance.measure("ionic:main.js-compile", "ionic:main.js-compile-start");' +
            ...
            promises.push(helpers_1.writeFileAsync(uglifyJsConfig.destFileName, code));
